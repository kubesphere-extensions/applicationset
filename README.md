...
## :warning: This project is only used to build multi-arch images for v0.4.1, the source project has been archived. Please look at https://github.com/argoproj/argo-cd for ArgoCD latest releases.
